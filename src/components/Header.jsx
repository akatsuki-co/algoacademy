        ...
        <Row className='align-items-center'>
          <Col lg="6" className="header-text">
            ...
            <p className='lead my-5'>
              ...
              a new programming language? Need to review data structures and algorithms?
              Look no further, this is your one stop shop to help you learn and improve. To
              get started, pick a language!
            </p>
          </Col>
